  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '新生大学 学习视频 短视频 excel' }
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'stylesheet', type: 'text/css', href: '//g.alicdn.com/sd/ncpc/nc.css?t=1517111086986' },
    ...
    script: [
      ...
      { type:'text/javascript', src:'//g.alicdn.com/sd/ncpc/nc.js?t=1517111086986', defer: true }
    ]
  },
